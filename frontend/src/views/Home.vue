...
const faqCategory1: FAQCategory = {
  ...
  items: [
    ...
    },
    {
      ...
      answer:
        'Мы используем алгоритм, который анализирует ваши предпочтения и находит наиболее подходящего собеседника.',
    },
    {
      question: 'Есть ли у нас доступ к вашим чатам?',
      answer: 'Нет, это нам не интересно и по техническим причинам невозможно.',
    },
  ],
}
...
const faqCategory2: FAQCategory = {
  ...
  items: [
    ...
    },
    {
      ...
      answer: 'Вы можете написать в наш Telegram-канал для получения помощи.',
    },
  ],
}
</script>
